				...
				<div className="container">
					<div className="row align-items-end">
						<div className="col-lg-7 me-auto">
							<h3 className="ds-3 mt-3 mb-3 text-primary-1">Real Projects. Real Impact.</h3>
							<span className="fs-5 fw-medium text-200">
								From scalable e-commerce systems to ERP platforms and healthcare dashboards,<br />
								my code powers businesses and delivers results across industries.
							</span>
						</div>
